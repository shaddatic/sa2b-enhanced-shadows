...
#define PL_EQUIP_SONIC_LIGHTSHOES			0x00000001
#define PL_EQUIP_SONIC_ANCIENTLIGHT			0x00000002
#define PL_EQUIP_SONIC_MAGICHANDS			0x00000004
#define PL_EQUIP_SONIC_FLAMERING			0x00000008
#define PL_EQUIP_SONIC_BOUNCEBRACELET		0x00000010
#define PL_EQUIP_SONIC_MYSTICMELODY			0x00000020

#define PL_EQUIP_MILES_BOOSTER				0x00000040
#define PL_EQUIP_MILES_BAZOOKA				0x00000080
#define PL_EQUIP_MILES_LASERBLASTER			0x00000100
#define PL_EQUIP_MILES_MYSTICMELODY			0x00000200

#define PL_EQUIP_KNUCKLES_SHOVELCLAW		0x00000400
#define PL_EQUIP_KNUCKLES_SUNGLASSES		0x00000800
#define PL_EQUIP_KNUCKLES_HAMMERGLOVES		0x00001000
#define PL_EQUIP_KNUCKLES_AIRNECKLACE		0x00002000
#define PL_EQUIP_KNUCKLES_MYSTICMELODY		0x00004000

#define PL_EQUIP_SUPERSONIC					0x00008000

#define PL_EQUIP_SHADOW_AIRSHOES			0x00010000
#define PL_EQUIP_SHADOW_ANCIENTLIGHT		0x00020000
#define PL_EQUIP_SHADOW_FLAMERING			0x00040000
#define PL_EQUIP_SHADOW_MYSTICMELODY		0x00080000

#define PL_EQUIP_EGGMAN_JETENGINE			0x00100000
#define PL_EQUIP_EGGMAN_LARGECANNON			0x00200000
#define PL_EQUIP_EGGMAN_LASERBLASTER		0x00400000
#define PL_EQUIP_EGGMAN_PROTECTIVEARMOR		0x00800000
#define PL_EQUIP_EGGMAN_MYSTICMELODY		0x01000000

#define PL_EQUIP_ROUGE_PICKNAILS			0x02000000
#define PL_EQUIP_ROUGE_TREASURESCOPE		0x04000000
#define PL_EQUIP_ROUGE_IRONBOOTS			0x08000000
#define PL_EQUIP_ROUGE_MYSTICMELODY			0x10000000
