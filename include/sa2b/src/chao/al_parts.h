...
DataAry(cnkobj**, pPartsObjectListChild, 0x012E59A0, [20]);
DataAry(cnkobj**, pPartsObjectListAdult, 0x012E5938, [20]);

DataAry(sint16, AL_PartAttr, 0x011C47D0, [40]);

void AL_SetItem(task* tp, sint32 TreeNum, cnkobj* pObject);
