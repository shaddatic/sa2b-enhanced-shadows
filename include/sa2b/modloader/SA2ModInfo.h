...
#define patchdecl(address,string) { (void*)address, arrayptrandsize(string) }
#define ptrdecl(address,string) { (void*)address, (void*)string }
...
struct HelperFunctions
{
	...
	*/
	...
	// Requires version >= 8
	void(__cdecl* SetDebugFontSize)(float elemsize);
