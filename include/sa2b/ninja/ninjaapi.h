...
void	njDrawPolygon2D(NJS_POINT2COL *p, Int n, float32 pri, uint32 attr);
...
FuncPtr(sint32, __thiscall, njSetTexture, (NJS_TEXLIST* texlist), 0x42ED20);
...
FuncPtr(sint32, __cdecl, njReleaseTexture, (NJS_TEXLIST* texlist), 0x0077F9F0);
