...
#pragma comment(lib,"sa2b-toolkit.lib")
...
/*
*	Game User(call/purge) Function References
*/
#define FuncUsr(TYPE, NAME, ARGS, ADDR) const void* NAME##_p = (void*)ADDR; TYPE NAME##ARGS
...
*	Other Definitions
*/
#define GetRegister(TYPE, TO, FROM) TYPE TO; __asm mov[TO], FROM